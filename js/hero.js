...
window.addEventListener("DOMContentLoaded", () => {
  ...
  if (skip) {
    //kommer tilbage fra en anden side - spring animation over
    ...
    return; //Stopper resten af hero-scriptet - Ingen animationsfunktioner bliver kaldt
  }
  hideAll();
  ...
  heroImg.addEventListener(
    ...
    { once: true } //event listeneren kun kører én gang og derefter automatisk fjernes
  );
});
