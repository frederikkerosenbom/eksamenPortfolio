...
function erForsideLink(href) {
  return (
    href === "/" || // === præcis det samme // || er eller
    href === "index.html" ||
    href === "#forside" ||
    href.endsWith("/index.html") ||
    href.endsWith("/#forside")
  );
}
...
document.addEventListener("click", function (event) {
  ...
  //gemmer en værdi i sessionStorage, som bruges på forsiden til at styre,
  // om hero-animationen skal afspilles eller springes over.
});
